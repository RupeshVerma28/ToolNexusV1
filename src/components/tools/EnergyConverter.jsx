...
const EnergyConverter = () => {
  ...
  const convert = () => {
    ...
    const joules = val * units[fromUnit].factor;
    const result = joules / units[toUnit].factor;
    setResult(result.toFixed(6));
  };

  return (
    <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 max-w-md mx-auto">
      <h3 className="text-2xl font-semibold text-white mb-4">Energy Converter</h3>
      <p className="text-gray-400 text-sm mb-4">Convert between different energy units</p>
